...
top_provinces=['roma','milano','venezia','firenze','rimini','jesolo','caorle','torino','riccione','cervia','napoli','bologna']
...
stop_words=stop_words+['marcare','rodere','camera','venezia','hotel']
stop_words=stop_words+top_provinces
